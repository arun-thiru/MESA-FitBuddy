# MESA-FitBuddy
MSEA TEAM FitBuddy - Al Fitness Plan Generator
------------------------------------------------------------------

•A personalized Al-powered fitness and diet plan generator built using Google Gemini Al and Streamlit.
...
•Member 3: [Muthusurenther M Name]

•Member 4: [Arun T Name]

Tech Stack
__________________________________________________________________
Language: Python

•Al Model: Google Gemini API (gemini-2.5-flash)
